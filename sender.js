    ...
    html: 
        ...
        <section style="color: #444444; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 20px;">
            ...
            <div style="font-size:12px;">
                ...
                После того как база кормов создана, Вы можете не только легко найти и посмотерть все показатели кормов за любой год,
                <br/>
            ...
            <p style="font-size:14px;">
                ...
                <br/>
                <span style="color: #666;font-size:12px;">
                    С какого имеено поля кукурзузный силос с наибольшей Обменной Энергией
                </span>
                <br/>
                <span style="color: #666;font-size:12px;">
            ...
            <p style="font-size:14px;">
                ...
                <br/>
                <span style="color: #666;font-size:12px;">
                    Какое процентное соотнешение из общей массы сенажа состовляет козлятник, а сколько люцерна
                </span>
                <br/>
                <span style="color: #666;font-size:12px;">
            ...
            <p style="font-size:14px;">
                ...
                <br/>
                <span style="color: #666;font-size:12px;">
                    Получить рейтинг травянах сенажей предприятия на основе этих показателей
                </span>
                <br/>
